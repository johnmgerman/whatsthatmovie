...
-->
		...
		<?= $this->Html->css('easy-responsive-tabs.min.css') ?>
        ...
        <script src="http://localhost:4322/asdfasdf/js/vendor/modernizr-2.8.3-respond-1.4.2.min.js"></script>
		<script src="http://localhost:4322/asdfasdf/js/vendor/jquery-1.11.2.min.js"></script>
    </head>
    <body>
        <!--[if lt IE 8]>
          ...
          <div class="col-md-12">
            ...
            <div class="VerticalTab VerticalTab_hash_scroll VerticalTab_6 tabs_ver_6">
              ...
              <ul class="resp-tabs-list hor_1">
                <a href='<?php echo $this->Url->build(["controller" => "Movies", "action" => "index"]) ?>'><div class="logo"><img src="img/logo.png"></div></a>
				<li><a href='<?php echo $this->Url->build($Auth); ?>'><span class="tabs-text"><?= $Auth['action']; ?></span></a></li>
				<li style="<?= $Add ?>"><a href='<?php echo $this->Url->build(["controller" => "Users", "action" => "add"]); ?>'><span class="tabs-text">Add</span></a></li>
				<br /><br />
				<li><a href='<?php echo $this->Url->build(["controller" => "Contacts", "action" => "index"]) ?>'><span class="tabs-text">Contact</span></a></li>
				<br /><br /><br />
                ...
                <!--<div class="fc-tab-1"
                  ...
                  <div class="home-container">
                    <div class="row">
                      ...
                      ======$this->assign('title', 'View Active Users');<div class="col-md-6">
    ...
    <!-- End HorizontalTab style 6 -->
      ...
      <footer>
        <p>Copyright &copy; 2017 What's That Movie? 
                                
        | Design: <a href="http://www.templatemo.com" target="_parent"><em>template mo</em></a>
			| Check out the new logo that I created on <a href="http://logomakr.com" title="Logo Makr">LogoMakr.com</a> <a href="https://logomakr.com/645LgZ">https://logomakr.com/645LgZ</a></p>
      </footer>
    </div> <!-- /container -->        
        ...
        <script src="http://localhost:4322/asdfasdf/js/vendor/bootstrap.min.js"></script>
        <script src="http://localhost:4322/asdfasdf/js/plugins.js"></script>
        <script src="http://localhost:4322/asdfasdf/js/main.js"></script>
        <script src="http://localhost:4322/asdfasdf/js/jquery.nicescroll.min.js"></script>
        <script src="http://localhost:4322/asdfasdf/js/easyResponsiveTabs.js"></script>
